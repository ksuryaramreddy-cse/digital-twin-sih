...
export default function BharatiHeader({ 
  name = "BHARATI", 
  ...
  return (
    <div className="tactical-panel rounded-2xl p-6 border border-sky-500/30 bg-gradient-to-r from-polar-950 via-polar-900 to-polar-950 shadow-2xl relative overflow-hidden">
      {/* Subtle background glow effect */}
      <div className="absolute top-0 right-0 w-96 h-48 bg-sky-500/5 rounded-full blur-3xl pointer-events-none"></div>

      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        {/* Left Title & Station Coordinates */}
        <div className="space-y-3">
          <div className="flex flex-wrap items-center gap-2.5">
            <span className="px-2.5 py-1 text-xs font-mono font-black bg-sky-950/90 text-sky-300 border border-sky-500/40 rounded tracking-wider">
              {code}
            </span>
          ...
          <div>
            <div className="flex items-baseline space-x-3">
              ...
              <span className="text-sm sm:text-lg font-mono font-semibold text-sky-400">
                {subtitle}
              </span>
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 border-t lg:border-t-0 lg:border-l border-polar-750 pt-4 lg:pt-0 lg:pl-6">
          ...
          <div className="bg-polar-900/90 p-3 rounded-xl border border-polar-800">
            ...
            <span className="text-[10px] font-mono text-amber-400/80">Low Fuel Notice</span>
          </div>
